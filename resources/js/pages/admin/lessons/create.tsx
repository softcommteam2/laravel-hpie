...
export default function LessonsCreate() {
    ...
    function addTranslation() {
        setData('translations', [
            ...data.translations,
            { locale: '', title: '', description: '', activity_content: '' },
        ]);
    }
    ...
    function removeTranslation(index: number) {
        setData(
            'translations',
            data.translations.filter((_, i) => i !== index),
        );
    }
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Create', href: '/admin/lessons/create' },
            ]}
        >
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                    ...
                    <div>
                        ...
                        <Textarea
                            ...
                            onChange={(e) =>
                                setData('author_bio', e.target.value)
                            }
                        />
                    </div>
                    <div>
                        <Label htmlFor="activity_content">
                            Activity Content
                        </Label>
                        <Textarea
                            id="activity_content"
                            value={data.activity_content}
                            onChange={(e) =>
                                setData('activity_content', e.target.value)
                            }
                            rows={6}
                        />
                    </div>
                        ...
                        {data.translations.map((t, i) => (
                            ...
                            >
                                ...
                                <Textarea
                                    ...
                                    placeholder="Translated activity content"
                                />
                            </div>
                        ))}
                    </div>
                    ...
                    <Button type="submit" disabled={processing}>
                        {processing ? 'Saving...' : 'Create Lesson'}
                    </Button>
                </form>
            </div>
        </AppLayout>
